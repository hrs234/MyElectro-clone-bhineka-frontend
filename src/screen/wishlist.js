        ...
        return (
            ...
            <ScrollView>
                ...
                <View style={{ marginBottom: 300 }}>
                    ...
                    numColumns={2}
                    renderItem={({ item }) => 
                        <View style={{borderColor: "#DEDEDE", width: 178, height: 330,  borderWidth: 1, borderColor: '#d6d7da' }}>
                            <View style={{ display: "flex" }}>
                                <Image source={require('../icons/indonesia.jpg')} style={{width: 176, height: 160, marginBottom: 70}} />
                                <View style={{ marginLeft: 23}}>
                                    <Text style={{ fontSize: 20, marginBottom: 35 }}>{item.nameCategory}</Text>
